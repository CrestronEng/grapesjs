...
import LayerManager from '../../../navigator/index';
import ItemsView from '../../../navigator/view/ItemsView';
...
export default class ItemView extends View {
  ...
  handleEditEnd(ev?: KeyboardEvent) {
    ...
    em.trigger('itemview:change', this, this.model, name); // this event is not a native GrapesJS event, it was added for CCIDE
  ...
  startSort(ev: MouseEvent) {
    ...
    if (sorter) {
      ...
      sorter.onEndMove = function (a: any, b: any, data: any) {
        getOnComponentDragEnd(em, [toMove]).call(this, a, b, data);
        em.trigger('itemsview:change', a, {
          ...data,
