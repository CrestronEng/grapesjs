      ...
      let mediaString =
        orientation === 'landscape'
          ? `(orientation: ${orientation}) and (${conditionMaxWidth}: ${maxWidth +
              1}px) and (${conditionMaxHeight}: ${maxHeight +
              1}px), (orientation: ${orientation}) and (${conditionMaxWidth}: ${maxWidth -
              1}px)`
          : `(orientation: ${orientation}) and (${conditionMaxHeight}: ${maxHeight +
              1}px) and (${conditionMaxWidth}: ${maxWidth +
              1}px), (orientation: ${orientation}) and (${conditionMaxHeight}: ${maxHeight -
              1}px)`;
